...
plot(fit)
rect.hclust(fit, k=11)

###Save the dendrogram as PNG image file
png("./dendrogram_sparse_free_com_k11.png", width = 1200, height=600)
plot(fit)
...
write.table(df_groups, "./tc_result_free_com_k11.txt", row.names=FALSE, col.names=TRUE, sep="\t")
